...
- Can style React components with className or by inline styling.
- Note that for styles, its an object of styles not a string of styles, unlike
  HTML.
- className and styles represent the DOM properties rather than the HTML
  attributes.
- When passing ...otherProps it will override the previous properties so you
  have to destructure the props that you want to be combined and then add the
  spread after.
