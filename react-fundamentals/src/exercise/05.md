...
- Note that for styles, its an object of styles not a string of styles, unlike HTML. 
- className and styles represent the DOM properties rather than the HTML attributes. 
